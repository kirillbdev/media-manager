<div id="media-manager">
  <div class="media-manager-wrap" v-bind:class="{ active: opened }">
    <div class="media-manager" v-bind:class="{ active: opened, loading: loading }">
      ...
      <div class="media-manager__toolbar">
        <a href="#" v-on:click.prevent="createFolder" class="media-manager__tool-btn media-manager__tool-btn--folder-add" title="Создать папку"></a>
      </div>
      <div class="media-manager__files">
        ...
        >
          ...
          <div class="media-manager-item__name">@{{ file.name }}</div>
        </div>
  ...
  window.MediaManager = new Vue({
    ...
    created: function () {
      ...
      document.body.addEventListener('click', function (event) {
        if ( $mm.opened && ! event.target.closest('.media-manager')) {
